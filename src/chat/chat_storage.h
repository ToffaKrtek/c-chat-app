...
typedef struct {
  ...
  bool (*get_message)(chat_storage_t *self, uint32_t id, chat_message_t *message);
  bool (*get_messages)(chat_storage_t *self, uint32_t chat_id, chat_message_t *out, uint32_t *count);
  bool (*create_message)(chat_storage_t *self, chat_message_t *message);
  bool (*update_message)(chat_storage_t *self, chat_message_t *message);
  bool (*delete_message)(chat_storage_t *self, uint32_t id);
} storage_v_table_t;
